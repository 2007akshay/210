...
def disconnectWithClient(message, client, client_name):
   ...
   if(entered_client_name in clients):
       ...
       other_clients_socket = clients[entered_client_name]["client"]

       greet_message = f"hello , {entered_client_name} {client_name} disconnected"
       other_clients_socket.send(greet_message.encode())
